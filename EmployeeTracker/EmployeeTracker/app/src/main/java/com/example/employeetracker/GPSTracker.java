...
import com.example.employeetracker.activities.EmpolyeeTaskList;
...
public class GPSTracker extends Service implements LocationListener {
 ...
 uploadTracks(PrefUtil.getString(GPSTracker.this, ApiParams.UID, ApiParams.UID),String.valueOf(location.getLatitude()),String.valueOf(location.getLongitude()));
	}
